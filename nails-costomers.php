...
//class responsable to load existing nails users for given coupons 
Class NailsCustomer 
{
	function NailsCustomer()
	{
		//massage on upload exist user
    ...
    <div class="ipage makeupprofilepage">
        ...
        <?php
		//if the user exist we will upload his data fron data-base
		if($this->Mode == 'save')
		{
		...
		//if the artist incriments number of treatments
